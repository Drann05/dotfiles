...
Rectangle {
    ...
    Image {
        ...
        source: "/home/drann/assets/chest.png"
        ...
        RowLayout {
            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    implicitWidth: 31
                    implicitHeight: 31
                    radius: 4 // Leggero arrotondamento per ammorbidire il look

                    // Rettangolo interno per simulare la luminosità/bagliore in modo pulito
                    Rectangle {
                        anchors.fill: parent
                        anchors.margins: 0
                        radius: 2
                        color: passwordBox.length > r.modelData ? "#ffffff" : "transparent"
                        opacity: passwordBox.length > r.modelData ? 0.8 : 0.0
